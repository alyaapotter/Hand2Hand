...
if ($role == 'Admin') {
    $nav_links = "<a href='../admin/dashboard.php'>Dashboard</a> | <a href='../admin/beneficiaries.php'>Beneficiaries</a> | <a href='../admin/event_management.php'>Events</a> | <a href='../admin/inventory.php'>Inventory</a> | <a href='../admin/distribution.php'>Distribution</a>";
} elseif ($role == 'Donor') {
