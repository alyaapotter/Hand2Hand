...
if ($role == 'Admin') {
    $nav_links = "<a href='../admin/dashboard.php'>Dashboard</a> | <a href='../admin/beneficiary.php'>Beneficiaries</a> | <a href='../admin/beneficiary_needs.php'>Requests</a> | <a href='../admin/donation_event.php'>Events</a> | <a href='../admin/inventory.php'>Inventory</a> | <a href='../admin/distribution_management.php'>Distribution</a>";
} else if ($role == 'Donor') {
