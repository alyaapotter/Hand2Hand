...
<header class="donor-header">
    ...
    <nav class="donor-nav">
        ...
        <a href="donation_history.php">My Donations</a>
    </nav>
</header>
...
<main class="content-container">
    ...
    <section class="events-section">
        ...
        <div class="events-grid">
            ...
            <div class="event-card">
                <div class="image-placeholder">
                    <img src="../image/women.jpg" alt="Her Essentials">
                </div>
            ...
            <div class="event-card">
                <div class="image-placeholder">
                    <img src="../image/medical.jpg" alt="Medical Aid">
                </div>
            ...
            <div class="event-card">
                <div class="image-placeholder">
                    <img src="../image/clothes.jpg" alt="Wear & Share">
                </div>
