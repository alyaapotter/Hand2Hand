...
$query  = "SELECT d.distribution_id, d.date AS distribution_date, d.quantity, d.location, u.username AS beneficiary, i.name AS item, r.request_id, r.date AS request_date
           FROM DISTRIBUTION d
...
<div class="page-container">
    ...
    <div class="table-wrapper">
        <table class="data-table" id="mainTable">
            <thead>
                <tr>
                    <th>Distribution ID</th><th>Beneficiary</th><th>Item</th><th>Quantity</th><th>Date Requested</th><th>Date Distributed</th><th>Location</th><th>Actions</th>
                </tr>
            </thead>
            <tbody>
                <?php if (empty($distributions)): ?>
                    <tr><td colspan="8" class="empty-row">No distribution records yet.</td></tr>
                <?php else: ?>
                ...
                <tr>
                    ...
                    <td><?= $d['quantity'] ?></td>
                    <td><?= date('d M Y', strtotime($d['request_date'])) ?></td>
                    <td><?= date('d M Y', strtotime($d['distribution_date'])) ?></td>
